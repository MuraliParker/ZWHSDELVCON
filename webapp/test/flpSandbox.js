		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#whsdeliveryconsolidationwhsdeliveryconsolidation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"whsdeliveryconsolidationwhsdeliveryconsolidation-display": {
								"semanticObject": "whsdeliveryconsolidationwhsdeliveryconsolidation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=whs.delivery.consolidation.whsdeliveryconsolidation",
									"url": sap.ui.require.toUrl("whs/delivery/consolidation/whsdeliveryconsolidation")
								}
							}
						}
					}
