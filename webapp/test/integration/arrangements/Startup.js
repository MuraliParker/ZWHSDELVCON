sap.ui.define([
	"sap/ui/test/Opa5",
	"whs/delivery/consolidation/whsdeliveryconsolidation/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("whs.delivery.consolidation.whsdeliveryconsolidation.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "whs.delivery.consolidation.whsdeliveryconsolidation",
					async: true
				},
				hash: oOptions.hash,
