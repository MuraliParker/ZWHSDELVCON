		...
		onTheMasterPage : {
			...
			actions : {
				...
				iRememberTheListItem : function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						id: oBindingContext.getProperty("Partyno"),
						title: oBindingContext.getProperty("Partyno")
					};
				}
			},
			...
			assertions : {
				...
				theListShouldHaveAllEntries : function () {
					...
					// retrieve all DELIVERY_headSet to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet : "DELIVERY_headSet",
